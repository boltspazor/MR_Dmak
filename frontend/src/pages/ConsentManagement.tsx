...
const ConsentManagement: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'consent' | 'optout'>('consent');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Manage your communication preferences with D-MAK Medical Representatives. 
            You can give consent to receive messages or opt out at any time.
          </p>
        </div>
