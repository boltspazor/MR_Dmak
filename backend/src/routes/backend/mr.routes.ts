...
router.get('/message-statuses', mrController.getMRMessageStatuses);
router.post('/refresh-message-statuses', mrController.refreshMessageStatuses);
router.get('/:mrId/message-status-details', mrController.getMRDetailedMessageStatus);
